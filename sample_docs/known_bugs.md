...
- Suspected cause: email queue backpressure during peak hours.
- Status: Open

## BUG-095 — Error toast missing on 500 responses
- Severity: Low
- Environment: Staging
- When the API returns a 500, no error toast appears; the spinner just stops.
- Status: Open
